...
namespace Comdtwhatsapptenantstemplates\Component\Dt_whatsapp_tenants_templates\Administrator\Service\Html;
...
/**
 * Dt_whatsapp_tenants_templates HTML Helper.
 *
 * @since  1.0.0
 */
class DT_WHATSAPP_TENANTS_TEMPLATES
{
